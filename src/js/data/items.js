...
export const ITEM_DEFS = {
  ...
  key_treatment_plant: {
    id: 'key_treatment_plant',
    name: 'Control Room Access Key',
    description: 'A security override generated by hacking the facility terminal. It\'s not so much a key as a strongly-worded electronic suggestion that the door should open.',
    type: 'quest',
    weight: 0,
    value: 0,
    stackable: false,
  ...
  mutant_meat: {
    id: 'mutant_meat',
    name: 'Mutant Roach Meat',
    description: 'Meat from a Mutant Roach. Larger than regular radroach meat, and somehow even less appetizing. On the bright side, the extra radiation probably acts as a preservative.',
    type: 'consumable',
    effects: [{ type: 'heal', amount: 12 }],
    useMessage: 'You eat the mutant roach meat. It tastes like regular radroach meat soaked in regret and toxic waste.',
    weight: 0.5,
    value: 8,
    stackable: true,
  },
